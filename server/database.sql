...
VALUES
('Connaught Place', 'New Delhi', 1.50, 28.63150000, 77.21670000, 1.00),
('Karol Bagh', 'Central Delhi', 1.30, 28.65190000, 77.18880000, 1.00),
('Chandni Chowk', 'Old Delhi', 1.40, 28.65050000, 77.23030000, 1.00),
('Daryaganj', 'Central Delhi', 1.20, 28.64410000, 77.24050000, 1.00),
('Patel Nagar', 'Central Delhi', 1.20, 28.65340000, 77.16890000, 1.00),
('South Extension', 'South Delhi', 1.40, 28.56840000, 77.21980000, 1.00),
('Saket', 'South Delhi', 1.30, 28.52440000, 77.20660000, 1.00),
('Hauz Khas', 'South Delhi', 1.50, 28.54940000, 77.20010000, 1.00),
('Greater Kailash', 'South Delhi', 1.40, 28.54350000, 77.23660000, 1.00),
('Vasant Kunj', 'South West Delhi', 1.30, 28.52980000, 77.15850000, 1.00),
('Green Park', 'South Delhi', 1.30, 28.55890000, 77.20400000, 1.00),
('Defense Colony', 'South Delhi', 1.40, 28.57460000, 77.23410000, 1.00),
('Lajpat Nagar', 'South Delhi', 1.30, 28.56770000, 77.24330000, 1.00),
('Kalkaji', 'South East Delhi', 1.20, 28.54010000, 77.25620000, 1.00),
('New Friends Colony', 'South East Delhi', 1.30, 28.56540000, 77.26900000, 1.00),
('Okhla', 'South East Delhi', 1.20, 28.52220000, 77.27600000, 1.00),
('Mehrauli', 'South Delhi', 1.10, 28.51900000, 77.18180000, 1.00),
('Chhatarpur', 'South Delhi', 1.10, 28.49880000, 77.18340000, 1.00),
('Laxmi Nagar', 'East Delhi', 1.20, 28.62930000, 77.27640000, 1.00),
('Mayur Vihar', 'East Delhi', 1.30, 28.60530000, 77.29650000, 1.00),
('Anand Vihar', 'East Delhi', 1.20, 28.65010000, 77.31520000, 1.00),
('Shahdara', 'Shahdara', 1.10, 28.69460000, 77.29360000, 1.00),
('Janakpuri', 'West Delhi', 1.20, 28.62190000, 77.08780000, 1.00),
('Punjabi Bagh', 'West Delhi', 1.30, 28.66720000, 77.13540000, 1.00),
('Rajouri Garden', 'West Delhi', 1.30, 28.64150000, 77.11980000, 1.00),
('Paschim Vihar', 'West Delhi', 1.20, 28.66870000, 77.09270000, 1.00),
('Kirti Nagar', 'West Delhi', 1.20, 28.64330000, 77.14230000, 1.00),
('Rohini', 'North West Delhi', 1.10, 28.72970000, 77.10800000, 1.00),
('Pitampura', 'North West Delhi', 1.20, 28.69830000, 77.13840000, 1.00),
('Model Town', 'North Delhi', 1.30, 28.71830000, 77.19010000, 1.00),
('Civil Lines', 'North Delhi', 1.20, 28.68140000, 77.22270000, 1.00),
('Mukherjee Nagar', 'North Delhi', 1.10, 28.71120000, 77.20330000, 1.00),
('Dwarka Sector 21', 'New Delhi', 1.20, 28.55230000, 77.05830000, 1.00),
('Najafgarh', 'South West Delhi', 1.10, 28.60900000, 76.98550000, 1.00),
('Noida Sector 18', 'Noida', 1.40, 28.57010000, 77.32040000, 1.00),
('Cyber City', 'Gurugram', 1.80, 28.49010000, 77.08660000, 1.00);
